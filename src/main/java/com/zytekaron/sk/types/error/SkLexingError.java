...
public class SkLexingError extends SkError {
    private static final String ERROR_NAME = "LexingError";
    
    public SkLexingError(Position start, Position end, String details) {
        super(ERROR_NAME, start, end, details);
    }
    
    public SkLexingError(Token token, String details) {
